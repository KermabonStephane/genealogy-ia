...
public class GedcomWriter {
    ...
    private static final DateTimeFormatter HEADER_DATE_FORMATTER = DateTimeFormatter.ofPattern("d MMM yyyy",
            Locale.ENGLISH);
    ...
    public void writeSubmission(GedcomSubmission subn, Writer writer) throws IOException {
        ...
        if (subn.submitterXref() != null)
            writeLine(writer, new GedcomLine(1, null, "SUBM", subn.submitterXref()));
        if (subn.familyFileName() != null)
            writeLine(writer, new GedcomLine(1, null, "FAMF", subn.familyFileName()));
        if (subn.templeCode() != null)
            writeLine(writer, new GedcomLine(1, null, "TEMP", subn.templeCode()));
        if (subn.ancestorsCount() != null)
            writeLine(writer, new GedcomLine(1, null, "ANCE", subn.ancestorsCount()));
        if (subn.descendantsCount() != null)
            writeLine(writer, new GedcomLine(1, null, "DESC", subn.descendantsCount()));
        if (subn.ordinanceFlag() != null)
            writeLine(writer, new GedcomLine(1, null, "ORDI", subn.ordinanceFlag()));
    ...
    public void writeSubmitter(GedcomSubmitter subm, Writer writer) throws IOException {
        ...
        if (subm.name() != null)
            writeLine(writer, new GedcomLine(1, null, "NAME", subm.name()));
        if (subm.address() != null)
            writeLine(writer, new GedcomLine(1, null, "ADDR", subm.address()));
        if (subm.phone() != null)
            writeLine(writer, new GedcomLine(1, null, "PHON", subm.phone()));
        if (subm.email() != null)
            writeLine(writer, new GedcomLine(1, null, "EMAIL", subm.email()));
        if (subm.www() != null)
            writeLine(writer, new GedcomLine(1, null, "WWW", subm.www()));
        if (subm.language() != null)
            writeLine(writer, new GedcomLine(1, null, "LANG", subm.language()));
    ...
    public void writeSource(GedcomSource source, Writer writer) throws IOException {
        ...
        if (source.title() != null)
            writeLine(writer, new GedcomLine(1, null, "TITL", source.title()));
        if (source.author() != null)
            writeLine(writer, new GedcomLine(1, null, "AUTH", source.author()));
        if (source.publication() != null)
            writeLine(writer, new GedcomLine(1, null, "PUBL", source.publication()));
        if (source.abbreviation() != null)
            writeLine(writer, new GedcomLine(1, null, "ABBR", source.abbreviation()));
        if (source.repositoryXref() != null)
            writeLine(writer, new GedcomLine(1, null, "REPO", source.repositoryXref()));
        if (source.text() != null)
            writeLine(writer, new GedcomLine(1, null, "TEXT", source.text()));
    ...
    public void writeRepository(GedcomRepository repo, Writer writer) throws IOException {
        ...
        if (repo.name() != null)
            writeLine(writer, new GedcomLine(1, null, "NAME", repo.name()));
        if (repo.address() != null)
            writeLine(writer, new GedcomLine(1, null, "ADDR", repo.address()));
        if (repo.phone() != null)
            writeLine(writer, new GedcomLine(1, null, "PHON", repo.phone()));
        if (repo.email() != null)
            writeLine(writer, new GedcomLine(1, null, "EMAIL", repo.email()));
        if (repo.www() != null)
            writeLine(writer, new GedcomLine(1, null, "WWW", repo.www()));
    ...
    public void writeMultimedia(GedcomMultimedia media, Writer writer) throws IOException {
        ...
        if (media.format() != null)
            writeLine(writer, new GedcomLine(1, null, "FORM", media.format()));
        if (media.title() != null)
            writeLine(writer, new GedcomLine(1, null, "TITL", media.title()));
        if (media.fileMode() != null)
            writeLine(writer, new GedcomLine(1, null, "FILE", media.fileMode()));
    ...
    public void writeNote(GedcomNote note, Writer writer) throws IOException {
        ...
        if (note.value() != null) {
            // Simple splitting for CONC/CONT not fully implemented yet, just dumping first
            // line?
    ...
    public void writeFamily(GedcomFamily fam, Writer writer) throws IOException {
        ...
        if (fam.husbandXref() != null)
            writeLine(writer, new GedcomLine(1, null, "HUSB", fam.husbandXref()));
        if (fam.wifeXref() != null)
            writeLine(writer, new GedcomLine(1, null, "WIFE", fam.wifeXref()));
        ...
        for (GedcomEvent event : fam.events()) {
            ...
            if (event.date() != null)
                writeLine(writer, new GedcomLine(2, null, "DATE", event.date().date()));
            if (event.place() != null)
                writeLine(writer, new GedcomLine(2, null, "PLAC", event.place()));
            if (event.note() != null)
                writeLine(writer, new GedcomLine(2, null, "NOTE", event.note()));
        }
    ...
    public void writeHeader(GedcomHeader header, Writer writer) throws IOException {
        ...
        if (header.destinations() != null) {
            for (String dest : header.destinations()) {
                writeLine(writer, new GedcomLine(1, null, "DEST", dest));
            }
        }

        if (header.transmissionDate() != null) {
            if (header.transmissionDate().date() != null) {
                String formattedDate = header.transmissionDate().date().format(HEADER_DATE_FORMATTER).toUpperCase();
                writeLine(writer, new GedcomLine(1, null, "DATE", formattedDate));
            }
            if (header.transmissionDate().time() != null) {
                writeLine(writer, new GedcomLine(2, null, "TIME", header.transmissionDate().time().toString()));
            }
        }
    ...
    public void writeIndividual(GedcomIndividual ind, Writer writer) throws IOException {
        ...
        for (GedcomName name : ind.names()) {
            ...
            if (name.givenName() != null)
                writeLine(writer, new GedcomLine(2, null, "GIVN", name.givenName()));
            if (name.surname() != null)
                writeLine(writer, new GedcomLine(2, null, "SURN", name.surname()));
            if (name.nickname() != null)
                writeLine(writer, new GedcomLine(2, null, "NICK", name.nickname()));
            if (name.prefix() != null)
                writeLine(writer, new GedcomLine(2, null, "NPFX", name.prefix()));
            if (name.surnamePrefix() != null)
                writeLine(writer, new GedcomLine(2, null, "SPFX", name.surnamePrefix()));
            if (name.suffix() != null)
                writeLine(writer, new GedcomLine(2, null, "NSFX", name.suffix()));
        }
